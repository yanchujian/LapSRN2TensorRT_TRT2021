...
if __name__ == "__main__":
    ...
    parser.add_argument("--channel", type=int, default=1, help='input channel')
    ...
    parser.add_argument("--onnx_file_path", type=str, default='./results/lapsrn.onnx', help='onnx_file_path')
    parser.add_argument("--engine_file_path", type=str, default='./results/lapsrn_int8.trt', help='engine_file_path')
    ...
    if args.mode.lower() == 'int8':
        ...
        calib = CenterNetEntropyCalibrator(args)  #校准
    else:
        calib = None
