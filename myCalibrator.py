...
class CenterNetEntropyCalibrator(trt.IInt8EntropyCalibrator2):
    ...
    def __init__(self, args, files_path='val.txt'):
        trt.IInt8EntropyCalibrator2.__init__(self)

        self.cache_file = 'lapsrn.cache'  
        ...
        self.imgs = [os.path.join('calibrator_data',
                                  line.rstrip()) for line in self._lines] #rstrip删除空格
        self.batch_idx = 0
        ...
        self.device_input = cuda.mem_alloc(self.data_size) #分配内存
